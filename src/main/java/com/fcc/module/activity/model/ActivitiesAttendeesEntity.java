 ...
 */
@Entity
@Table(name = "activities_attendees", schema = "autosite", catalog = "")
public class ActivitiesAttendeesEntity {
    private int id;
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        ActivitiesAttendeesEntity that = (ActivitiesAttendeesEntity) o;
